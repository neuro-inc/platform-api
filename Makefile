...
test_integration:
	poetry run pytest -vv --maxfail=3 --durations=20 --cov platform_api --cov-config=pyproject.toml --cov-report xml:.coverage-integration.xml tests/integration/test_postgres.py::test_channel_notifier_connection_lost
