...
test_integration:
	poetry run pytest -x -s --log-cli-level=WARN -vv --maxfail=3 --durations=20 --cov platform_api --cov-config=pyproject.toml --cov-report xml:.coverage-integration.xml tests/integration
