...
test_integration:
	poetry run pytest -vv --retries=3 --retry-delay=15 --durations=20 --cov platform_api --cov-config=pyproject.toml --cov-report xml:.coverage-integration.xml tests/integration
