...
test_integration:
	poetry run pytest -vv --maxfail=3 --durations=20 --timeout=30 --cov platform_api --cov-config=pyproject.toml --cov-report xml:.coverage-integration.xml tests/integration
