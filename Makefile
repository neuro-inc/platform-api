...
test_integration:
	pytest -x -s --log-cli-level=DEBUG -vv --maxfail=3 --durations=20 --cov platform_api --cov-config=setup.cfg --cov-report xml:.coverage-integration.xml tests/integration
