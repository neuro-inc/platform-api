...
test_integration:
	pytest -vv --maxfail=3 --durations=20 --cov platform_api --cov-config=setup.cfg --cov-report xml:.coverage-integration.xml tests/integration --log-level DEBUG -k test_get_schedulable_jobs
