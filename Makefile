...
test_integration:
	poetry run pytest -vv --retries=3 --retry-delay=3 --maxfail=3 --durations=20 --cov platform_api --cov-config=pyproject.toml --cov-report xml:.coverage-integration.xml tests/integration -k check_dns_hostname_undeclared_port
