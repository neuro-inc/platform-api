...
function k8s::setup_ingress {
    ...
    find /etc/kubernetes/addons/ -name ingress* | xargs -L 1 sudo -E kubectl -n kube-sydockstem apply -f
    find /etc/kubernetes/addons/ -name kube-dns* | xargs -L 1 sudo -E kubectl -n kube-system apply -f
