...
class JobEnforcerClientWrapper:
    def __init__(self, session: aiohttp.ClientSession, config: JobPolicyEnforcerConfig):
...
class BaseJobEnforcer(JobPolicyEnforcer):
    def __init__(self, session: aiohttp.ClientSession, config: JobPolicyEnforcerConfig):
        self._wrapper = JobEnforcerClientWrapper(session, config)
